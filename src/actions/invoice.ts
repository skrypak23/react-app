...
export const fetchAllInvoices = () => action(INVOICE_TYPES.GET_INVOICES_REQUEST, URL_ALL_INVOICES);
...
export const createInvoice = (invoice: IInvoice) =>
  action(INVOICE_TYPES.CREATE_INVOICE_REQUEST, { url: URL_ALL_INVOICES, body: invoice });
...
export const editInvoice = (id: ID, invoice: IInvoice) =>
  action(INVOICE_TYPES.EDIT_INVOICE_REQUEST, { url: `${URL_ALL_INVOICES}/${id}`, body: invoice });
...
export const deleteInvoice = (id: ID) =>
  action(INVOICE_TYPES.DELETE_INVOICE_REQUEST, { url: `${URL_ALL_INVOICES}/${id}` });
...
export const setError = (error: string) => action(INVOICE_TYPES.FETCH_INVOICE_ERROR, error);
