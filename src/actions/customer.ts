...
export const resetCustomer = () => action(CUSTOMER_TYPES.RESET_CUSTOMER, 'error');
export const setError = (error: string) => action(CUSTOMER_TYPES.FETCH_CUSTOMER_ERROR, error);
