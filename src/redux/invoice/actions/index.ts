...
export const fetchDataSuccess = createStandardAction(
  INVOICE_TYPES.GET_INVOICES_SUCCESS
)<IInvoice[]>();
...
export const createSuccess = createStandardAction(
  INVOICE_TYPES.CREATE_INVOICE_SUCCESS
)<IInvoice>();
...
export const editSuccess = createStandardAction(
  INVOICE_TYPES.EDIT_INVOICE_SUCCESS
)<IInvoice>();
...
export const deleteSuccess = createStandardAction(
  INVOICE_TYPES.DELETE_INVOICE_SUCCESS
)<IInvoice>();

export const resetInvoice = createStandardAction(INVOICE_TYPES.RESET_INVOICE)<
  undefined
>();
