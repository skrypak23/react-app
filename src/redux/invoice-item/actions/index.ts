...
export const fetchDataSuccess = createStandardAction(INVOICE_ITEMS_TYPES.GET_INVOICE_ITEMS_SUCCESS)<IInvoiceItem[]>();

export const fillItems = createStandardAction(INVOICE_ITEMS_TYPES.FILL_INVOICE_ITEMS)<IInvoiceItem>();
...
export const fetchDataByIdSuccess = createStandardAction(INVOICE_ITEMS_TYPES.GET_INVOICE_ITEMS_BY_ID_SUCCESS)<IInvoiceItem>();
...
export const createSuccess = createStandardAction(INVOICE_ITEMS_TYPES.CREATE_INVOICE_ITEMS_SUCCESS)<IInvoiceItem>();
...
export const editSuccess = createStandardAction(INVOICE_ITEMS_TYPES.EDIT_INVOICE_ITEMS_SUCCESS)<IInvoiceItem>();
...
export const deleteSuccess = createStandardAction(INVOICE_ITEMS_TYPES.DELETE_INVOICE_ITEMS_SUCCESS)<IInvoiceItem>();

export const resetInvoiceItem = createStandardAction(INVOICE_ITEMS_TYPES.RESET_INVOICE_ITEMS)<undefined>();
export const setError = createStandardAction(INVOICE_ITEMS_TYPES.FETCH_INVOICE_ITEMS_ERROR)<string>();
